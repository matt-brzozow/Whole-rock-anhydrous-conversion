...
with st.expander("Important - read first"):
    ...
    st.write("The script takes all < and > symbols and replaces the cell with a 0. If you want to treat the data differently, do these modifications before uploading the CSV")
    st.write("-------------")
